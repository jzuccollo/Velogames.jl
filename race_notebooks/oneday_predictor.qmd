...
# Optional: Betfair Exchange market ID (leave empty to skip)
# Find the market ID on betfair.com/exchange -> cycling -> look at the URL
betfair_market_id = ""

# Optional: Cycling Oracle prediction URL (leave empty to skip)
# e.g. "https://www.cyclingoracle.com/en/blog/omloop-nieuwsblad-2026-prediction"
oracle_url = ""
...
# Optional: VG historical race results (year => results URL)
# Find URLs at velogames.com -> past results -> race score page
...
# Run the full prediction pipeline (cache_config inherited from config)
predicted, chosenteam = solve_oneday(config;
    racehash=racehash,
...
4. Optionally fetches betting odds from Betfair and/or Cycling Oracle predictions
...
- Set `betfair_market_id` for Betfair odds integration (strongest single signal when available)
- Set `oracle_url` for Cycling Oracle predictions (independent signal, good coverage of European races)
