...
The actual winning team in the Velogames competition scored `{julia} bestteamscore` points. What's the cheapest team you could have picked that would have beaten that team?
...
allriderdata[end-14:end, [:rider, :team, :cost, :score, :value]]
```
