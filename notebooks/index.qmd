...
Four notebooks cover the main use cases:

- **[One-day predictor](oneday_predictor.qmd)**: Pre-race team selection for Superclasico Sixes one-day races. Monte Carlo simulation converts rider strength estimates into expected VG points, then optimises a 6-rider team.
...
For Superclasico Sixes one-day races, teams are 6 riders with no classification constraints:
