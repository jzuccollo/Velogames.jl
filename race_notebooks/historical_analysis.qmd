...
subtitle: "Ronde van Vlaanderen 2024"
---
...
riderraceurl = "https://www.velogames.com/sixes-superclasico/2024/ridescore.php?ga=13&st=8"
...
The best team picked by a DPCC league member was Erricos Compsonios', which scored `{julia} bestteamscore` points. The cheapest team that would have beaten that scored `{julia} chosen2teampost.score |> sum` points and cost `{julia} chosen2teampost.cost |> sum` points:
