...
points_for_display = select(points_for_sorted, :rider => :Rider, :team => :Team, :class => :Class, :cost => :Cost, :points => :Points, :selected => :Selected, :points_for => :PointsFor)
points_for_display[!, :Points] = Int.(round.(points_for_display.Points))
points_for_display[!, :PointsFor] = Int.(round.(points_for_display.PointsFor))
points_for_display[!, :Selected] = string.(round.(points_for_display.Selected .* 100, digits=1), "%")
...
points_against_display = select(points_against_sorted, :rider => :Rider, :team => :Team, :class => :Class, :cost => :Cost, :points => :Points, :selected => :Selected, :points_against => :PointsAgainst)
points_against_display[!, :Points] = Int.(round.(points_against_display.Points))
points_against_display[!, :PointsAgainst] = Int.(round.(points_against_display.PointsAgainst))
points_against_display[!, :Selected] = string.(round.(points_against_display.Selected .* 100, digits=1), "%")
