...
riderraceurl = "https://www.velogames.com/sixes-superclasico/2024/ridescore.php?ga=13&st=5"
racehash = "#E3Saxo"
bestteamscore = 1665;
```
...
markdown_table(displaytable3[1:20, [:Rider, :Team, :Cost, :Score, :Value]])
```

## Worst picks

**Not available for this race because of boring data reasons. Expect it back for Gent-Wevelgem.**
