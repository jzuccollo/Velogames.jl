...
chosen_team_post = filter(row -> row.chosen, rider_vg_post)
...
rider_vg_post.chosen = model_post2_results.data .> 0.5
chosen2_team_post = filter(row -> row.chosen2, rider_vg_post)
